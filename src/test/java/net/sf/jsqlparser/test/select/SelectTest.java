...
public class SelectTest extends TestCase {
    ...
    public void testExtractXml() throws JSQLParserException {
        // https://docs.oracle.com/cd/B19306_01/server.102/b14200/functions051.htm
        String stmt = "SELECT warehouse_name, EXTRACT(warehouse_spec, '/Warehouse/Docks') \"Number of Docks\" FROM warehouses WHERE warehouse_spec IS NOT NULL";
        assertSqlCanBeParsedAndDeparsed(stmt);
    }
